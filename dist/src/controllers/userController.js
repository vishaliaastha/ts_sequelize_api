...
const userModel = database_1.default.users;
const contactDetailsModel = database_1.default.contact_details;
const contactIds = database_1.default.contact_id;
const familyDetailModel = database_1.default.family_detail;
...
const createFamilyDetail = async (req, res) => {
    try {
...
const getNestedJoins = async (req, res) => {
    try {
...
const getMutipleJoins = async (req, res) => {
    try {
        const detail = await userModel.findOne({
            where: { id: req.params.id },
            attributes: ['id', 'username', 'email'],
            include: [
                ...
                // {
                // model : familyDetailModel,
                // attribute : ['id','headOfFamily','caste'],
                // include : [{
                // model : contactDetailsModel,
                // attributes : ['phoneNumber','city','state'],
                // }]
